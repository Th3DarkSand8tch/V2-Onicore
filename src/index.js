...
const { getOnicoreDir } = require("./modules/onicorePaths");
...
function createWindow() {
  ...
  mainWindow = new BrowserWindow({
    ...
    icon: join(__dirname, "assets/images/onicore-launcher-icon.png"),
    transparent: true,
    webPreferences: {
      spellcheck: false,
  ...
  require("./modules/settingsManager")(mainWindow);
  require("./modules/modpackManager")(mainWindow);
  require("./modules/modpackPreferences")(mainWindow);
};

ipcMain.handle("openDirectory", async (event, path) => {
  const defaultPath = getOnicoreDir();
